...
{
  "$end", "error", "$undefined", "bindigit", "octdigit", "B", "O",
  "DELIM", "PLUS", "$accept", "E", "$@1", "S", "Sb", "So", "digit", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  case 2:
#line 18 "calc.y"
        { printf("Decimal Value: %d ",yyvsp[0]); ans=0; }
